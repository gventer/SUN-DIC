...
%--------------------------------------------
%-- Define constants
\newcommand{\version}{0.0.35}
\newcommand{\pyversion}{3.12}
...
\newpage
\input{sections/00_comments.tex}
\tableofcontents
\newpage

\mainmatter
\input{sections/01_about}
\input{sections/02_installation}
\input{sections/03_parameters}
\input{sections/04_gui_example}
\input{sections/05_api_example}
