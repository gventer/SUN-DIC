################################################################################
## This file is an unmodified version of the one found at
##
## https://github.com/dbstein/fast_interp
##
## The original code is licensed under the Apache License 2.0
## The original code was written by David Stein
##
...
def _extrapolate1d_y(f, k, o):
    for ix in range(o):
        ...
        if k == 3:
            f[:, il] = (
                4 * f[:, il + 1] - 6 * f[:, il + 2] + 4 * f[:, il + 3] - f[:, il + 4]
            )
            f[:, ih] = (
                4 * f[:, ih - 1] - 6 * f[:, ih - 2] + 4 * f[:, ih - 3] - f[:, ih - 4]
            )
        if k == 5:
            f[:, il] = (
                6 * f[:, il + 1]
...
def _interp1d_k5(f, xout, fout, a, h, n, p, o, lb, ub):
    ...
    for mi in numba.prange(m):
        ...
        asx[2] = 150 / 256 + ratx * (
            ...
            * (
                -34 / 48 / 2
                + ratx * (34 / 8 / 6 + ratx * (2 / 2 / 24 - 10 / 8 / 120 * ratx))
            )
        )
        asx[3] = 150 / 256 + ratx * (
            2250 / 1920
        ...
        asx[0] = -5 / 2048 + ratx * (
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -7 / 48 / 24
                        + ratx * (5 / 24 / 120 + ratx * (1 / 2 / 720 - 1 / 5040 * ratx))
                    )
                )
            )
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        59 / 48 / 24
                        + ratx
                        * (-59 / 24 / 120 + ratx * (-5 / 2 / 720 + 7 / 5040 * ratx))
                    )
                )
            )
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -135 / 48 / 24
                        + ratx
                        * (225 / 24 / 120 + ratx * (9 / 2 / 720 - 21 / 5040 * ratx))
                    )
                )
            )
        )
        asx[3] = 1225 / 2048 + ratx * (
            -128625 / 107520
            + ratx
            * (
                -9455 / 11520 / 2
                ...
                * (
                    ...
                    * (
                        83 / 48 / 24
                        + ratx
                        * (-415 / 24 / 120 + ratx * (-5 / 2 / 720 + 35 / 5040 * ratx))
                    )
                )
            )
        )
        asx[4] = 1225 / 2048 + ratx * (
            128625 / 107520
            + ratx
            * (
                -9455 / 11520 / 2
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -7 / 48 / 24
                        + ratx
                        * (-5 / 24 / 120 + ratx * (1 / 2 / 720 + 1 / 5040 * ratx))
                    )
                )
            )
        )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    420 / 24 / 5040
                                    + ratx * (20 / 2 / 40320 - 36 / 362880 * ratx)
                                )
                            )
                        )
                    )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    -1092 / 24 / 5040
                                    + ratx * (-28 / 2 / 40320 + 84 / 362880 * ratx)
                                )
                            )
                        )
                    )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    1722 / 24 / 5040
                                    + ratx * (14 / 2 / 40320 - 126 / 362880 * ratx)
                                )
                            )
                        )
                    )
...
def _interp2d_k5(f, xout, yout, fout, a, h, n, p, o, lb, ub):
    ...
    for mi in numba.prange(m):
        ...
        asy[2] = 150 / 256 + raty * (
            ...
            * (
                -34 / 48 / 2
                + raty * (34 / 8 / 6 + raty * (2 / 2 / 24 - 10 / 8 / 120 * raty))
            )
        )
        asy[3] = 150 / 256 + raty * (
            2250 / 1920
        ...
        asy[0] = -5 / 2048 + raty * (
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -7 / 48 / 24
                        + raty * (5 / 24 / 120 + raty * (1 / 2 / 720 - 1 / 5040 * raty))
                    )
                )
            )
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        59 / 48 / 24
                        + raty
                        * (-59 / 24 / 120 + raty * (-5 / 2 / 720 + 7 / 5040 * raty))
                    )
                )
            )
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -135 / 48 / 24
                        + raty
                        * (225 / 24 / 120 + raty * (9 / 2 / 720 - 21 / 5040 * raty))
                    )
                )
            )
        )
        asy[3] = 1225 / 2048 + raty * (
            -128625 / 107520
            + raty
            * (
                -9455 / 11520 / 2
                ...
                * (
                    ...
                    * (
                        83 / 48 / 24
                        + raty
                        * (-415 / 24 / 120 + raty * (-5 / 2 / 720 + 35 / 5040 * raty))
                    )
                )
            )
        )
        asy[4] = 1225 / 2048 + raty * (
            128625 / 107520
            + raty
            * (
                -9455 / 11520 / 2
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -7 / 48 / 24
                        + raty
                        * (-5 / 24 / 120 + raty * (1 / 2 / 720 + 1 / 5040 * raty))
                    )
                )
            )
        )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    420 / 24 / 5040
                                    + raty * (20 / 2 / 40320 - 36 / 362880 * raty)
                                )
                            )
                        )
                    )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    -1092 / 24 / 5040
                                    + raty * (-28 / 2 / 40320 + 84 / 362880 * raty)
                                )
                            )
                        )
                    )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    1722 / 24 / 5040
                                    + raty * (14 / 2 / 40320 - 126 / 362880 * raty)
                                )
                            )
                        )
                    )
...
def _interp3d_k5(f, xout, yout, zout, fout, a, h, n, p, o, lb, ub):
    ...
    for mi in numba.prange(m):
        ...
        asz[2] = 150 / 256 + ratz * (
            ...
            * (
                -34 / 48 / 2
                + ratz * (34 / 8 / 6 + ratz * (2 / 2 / 24 - 10 / 8 / 120 * ratz))
            )
        )
        asz[3] = 150 / 256 + ratz * (
            2250 / 1920
        ...
        asz[0] = -5 / 2048 + ratz * (
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -7 / 48 / 24
                        + ratz * (5 / 24 / 120 + ratz * (1 / 2 / 720 - 1 / 5040 * ratz))
                    )
                )
            )
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        59 / 48 / 24
                        + ratz
                        * (-59 / 24 / 120 + ratz * (-5 / 2 / 720 + 7 / 5040 * ratz))
                    )
                )
            )
        )
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -135 / 48 / 24
                        + ratz
                        * (225 / 24 / 120 + ratz * (9 / 2 / 720 - 21 / 5040 * ratz))
                    )
                )
            )
        )
        asz[3] = 1225 / 2048 + ratz * (
            -128625 / 107520
            + ratz
            * (
                -9455 / 11520 / 2
                ...
                * (
                    ...
                    * (
                        83 / 48 / 24
                        + ratz
                        * (-415 / 24 / 120 + ratz * (-5 / 2 / 720 + 35 / 5040 * ratz))
                    )
                )
            )
        )
        asz[4] = 1225 / 2048 + ratz * (
            128625 / 107520
            + ratz
            * (
                -9455 / 11520 / 2
            ...
            * (
                ...
                * (
                    ...
                    * (
                        -7 / 48 / 24
                        + ratz
                        * (-5 / 24 / 120 + ratz * (1 / 2 / 720 + 1 / 5040 * ratz))
                    )
                )
            )
        )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    420 / 24 / 5040
                                    + ratz * (20 / 2 / 40320 - 36 / 362880 * ratz)
                                )
                            )
                        )
                    )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    -1092 / 24 / 5040
                                    + ratz * (-28 / 2 / 40320 + 84 / 362880 * ratz)
                                )
                            )
                        )
                    )
                    ...
                    * (
                        ...
                        * (
                            ...
                            * (
                                ...
                                * (
                                    1722 / 24 / 5040
                                    + ratz * (14 / 2 / 40320 - 126 / 362880 * ratz)
                                )
                            )
                        )
                    )
